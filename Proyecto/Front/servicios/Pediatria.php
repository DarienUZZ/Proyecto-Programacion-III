  ...
  <div class="container mt-5">
    <section>
      ...
      <p class="ParrafoServiciosE">
        ...
        estado
        de enfermedad (Pediatría Clínica), y a cuanto atañe al niño y adolescente sano y enfermo en sus
        interrelaciones
        individuales y con la comunidad en el medio físico y humano en que de manera ininterrumpida y con
        características propias se desarrolla (Pediatría Social).
      </p>
      <div class="text-center">
        <img src="../img/imgServicios/imgServicio2.jpg" alt="Pediatria" class="img-fluid mt-4"
    ...
    <section class="mt-5 mb-5">
      ...
      <p class="ParrafoServiciosE">
        ...
        el
        adolescente con el fin de encontrar o prevenir problemas. Asimismo, la valoración de estudios de la audición y
        la visión y otros exámenes serán parte de algunas de las consultas o controles. Incluso, si su hijo o hija
        está
      ...
      <p class="ParrafoServiciosE">
        ...
        dolor
        de oídos, alergias y brotes en la piel, fiebre, vómitos, diarrea, dolor abdominal, entre otros. Una valoración
        apropiada por el pediatra en un ambiente seguro y cálido para su hijo o hija permitirá establecer un
        diagnóstico
      ...
      <p class="ParrafoServiciosE">
        ...
        tales
        como el trastorno de déficit atencional con inatención, impulsividad o hiperactividad, trastornos de conducta
        o
        trastornos del espectro autista, entre otros; en los cuales, una intervención multidisciplinaria pronta podría
        ayudar a buscar los enfoques que funcionan mejor para el diagnóstico de su hijo o hija, y poder colaborarle a
        mejorar y salir adelante, y que sea feliz en todos sus entornos, y por consiguiente sus familias y
        profesorado.
      </p>
    </section>
  </div>
