...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5">
      <section>
        <h2 class="text-center">¿Qué es la Geriatría?</h2>
        <p>
        ...
        <div class="text-center">
          <img src="imgServicios2/Geriatria.jpg" alt="Geriatría" class="img-fluid mt-4" style="max-width: 40%; height: auto;" />
        </div>
      </section>

      <section class="mt-5">
        <h2 class="text-center">¿Quiénes necesitan ir al Geriatra?</h2>
        <ul>
          <li>Mayores de 65 años sanos, en los cuales es necesario enfocar actividades preventivas personales para lograr un envejecimiento exitoso. El control anual permite la recomendación de estilos de vida, nutrición, ejercicio físico y actividad mental, exámenes personalizados y vacunas específicas para este grupo de pacientes. Permite, además, la detección precoz de disminución de memoria y capacidad cognitiva, pérdidas insignificantes de funcionalidad y estar alerta ante la presencia de signos y síntomas que predicen la aparición de enfermedades, sobre todo de algunos cánceres.</li>
          <li>Mayores de 65 años con más de tres enfermedades crónicas, que habitualmente ingieren más de cinco fármacos diferentes. El foco en estos pacientes es evitar la interacción de medicamentos que produzcan eventos adversos, recomendar actividades para evitar la progresión de las enfermedades o que se agreguen complicaciones de las mismas, manteniendo la capacidad para funcionar en forma autónoma.</li>
          <li>Pacientes mayores de 80 años, con o sin patología crónica. Estos pacientes presentan disminución de sus capacidades fisiológicas y están expuestos a presentar enfermedades agudas que con facilidad necesitan de hospitalización para mejorarlos.</li>
          <li>Pacientes que presentan enfermedades propias del envejecimiento, como demencia, incontinencia urinaria, alteraciones de la marcha y osteoporosis, entre otras.</li>
          <li>Adultos mayores institucionalizados en casas de reposo. El uso de un método específico para examinar a estos pacientes, el contacto estrecho con la familia y sobre todo con el cuidador principal, les permite preservar su funcionalidad física y mental y disminuir la velocidad de declinación a medida que envejecen. Hay una mejoría importante en la satisfacción de la familia y reduce la posibilidad de hospitalización.</li>
        </ul>
      </section>
