    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          <p class="ParrafoDescFooter">
            <i class="fas fa-clock"></i> Lunes–Viernes: 8am – 8pm<br />
            Sabados: 7am – 5pm<br />
            Domingos: Cerrados
          </p>
        </div>
        <div class="col-md-3">
          ...
          <p class="ParrafoDescFooter"><i class="fas fa-phone"></i> 43500759</p>
          <p class="ParrafoDescFooter"><i class="fas fa-envelope"></i> info@perteneser.com</p>
          <p class="ParrafoDescFooter">
            <i class="fas fa-map-marker-alt"></i>Plaza Torres de Heredia
            Frente a Zona Franca Metropolitana Ulloa, Heredia. Costa Rica
          </p>
        </div>
      </div>
    </div>
